...
export function Content() {
  ...
  return (
    <div className="w-full h-full bg-background/70 rounded-md markdown flex flex-col p-6 h-limits overflow-scroll">
      <Markdown remarkPlugins={[remarkGfm]} rehypePlugins={[raw]}>
        {markdown}
      </Markdown>
    </div>
  );
